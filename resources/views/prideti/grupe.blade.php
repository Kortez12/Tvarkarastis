...
@section('content')
    <div class="container">
        <div class="col-lg-4 col-md-6 col-sm-4 col-xs-1 mx-auto pt-5">
            <h1 class="h2 text-center">Pridėti grupę į sąrašą</h1>
            <form class="row needs-validation g-2" action="{{ url('grupe/prideta') }}" method="POST">
                @csrf
                <div class="p-1">
                ...
                <div class="p-1">
                    ...
                    <input type="text" name="kodas" class="form-control @error('kodas') is-invalid @enderror">
                    @error('kodas')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
